  ...
  return (
    <>
      <div className="flex items-end justify-between gap-4 mb-[18px]">
        ...
        <div className="text-[12px] px-2.5 py-1.5 rounded-full border border-slate-200 text-gray-500 bg-slate-100" aria-label="Status">
          Status: Ready
        </div>
      </div>
      ...
      <div className="grid grid-cols-12 gap-[14px]">
        {content.cards.map((c) => (
          <section
            key={c.title}
            className={`bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-[0_1px_2px_rgba(16,24,40,0.04)] min-w-0 ${
        ...
        <section className="bg-slate-50 border border-slate-200 rounded-2xl p-4 shadow-[0_1px_2px_rgba(16,24,40,0.04)] min-w-0 col-span-12">
          ...
          <div className="h-[220px] grid place-items-center text-gray-500 border-2 border-dashed border-slate-200 rounded-xl bg-slate-100">
            Coming soon
          </div>
        </section>
      </div>
