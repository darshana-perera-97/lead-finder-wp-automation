        ...
        {waLoading ? (
          ...
          <div className="space-y-4">
            ...
            <dl className="grid grid-cols-12 gap-3 m-0">
              <div className="col-span-12 sm:col-span-6 rounded-xl border border-gray-100 bg-gray-50/80 px-3 py-2.5">
              ...
              {account?.widSerialized ? (
                <div className="col-span-12 rounded-xl border border-gray-100 bg-gray-50/80 px-3 py-2.5">
